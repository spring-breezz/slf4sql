...
import sb.slf4sql.handler.PreparedStatementHandler;
import sb.slf4sql.handler.StatementHandler;
...
public class ProxyConnection implements Connection {
	...
	public Statement createStatement() throws SQLException {
		...
		return StatementHandler.newInstance(s);
	}

	@Override
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		PreparedStatement ps = connection.prepareStatement(sql);
		return PreparedStatementHandler.newInstance(ps, sql);
	}
	...
	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
		CallableStatement ps = connection.prepareCall(sql, resultSetType, resultSetConcurrency);
		return PreparedStatementHandler.newInstance(ps, sql);
	}
	...
	public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		CallableStatement ps = connection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability);
		return PreparedStatementHandler.newInstance(ps, sql);
	}
